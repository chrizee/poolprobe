...
<?php
		   ...
		   document.getElementById('div<?php echo $i;?>').style.left = '<?php echo $left[$i];?>px';	
...
var col_size = document.getElementById("col-size").clientWidth;
	...
	if (l < col_size ) {
		...
		document.getElementById('reposition').innerHTML="Position "+Math.round(0)+', '+dragposition.top;
	...
	if (l > (col_size*12) ) {
		...
		document.getElementById('reposition').innerHTML="Position "+Math.round(col_size*11)+', '+dragposition.top;
	...
	for (i = 2; i < 13; i++) {
		...
		if ( (l > Wstart) && (l < Wend) ) {
			...
			document.getElementById('reposition').innerHTML="Position "+Math.round(Wstart)+', '+dragposition.top;
