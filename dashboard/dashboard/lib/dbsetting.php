...
<body>
 ...
 <!-- Modal -->
			...
			<form id="dbsetting" class="form-horizontal" enctype="multipart/form-data" action="dbsetting.php?task=save&layout=<?php echo $_GET['layout'];?>&col=<?php echo $_GET['col'];?>" method="post" onsubmit="return validateForm();">
			<fieldset>
			 </br>
